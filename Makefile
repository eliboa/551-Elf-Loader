...
all: setup main550 main540 main532 main500 main410 main400 main310 main300 main210 main200
setup:
	mkdir -p $(root)/bin/
main550:
...
main540:
	...
	cp -r $(root)/*.o $(build)
	rm $(root)/*.o
	$(LD) $(LDFLAGS) -o $(build)/code540.bin $(build)/loader.o `find $(build) -name "*.o" ! -name "loader.o"`
main532:
